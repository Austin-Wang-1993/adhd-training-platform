...
import { Menu, X, Home, Gamepad2, LogOut, User } from 'lucide-react';
...
const navigation = [
  ...
  { name: '数字游戏', href: '/number-game', icon: Gamepad2 },
];
      ...
      <div className={cn(
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-xl font-semibold text-gray-900">ADHD训练平台</h1>
            <button
